...
*/}}
{{- define "kub2.labels" -}}
helm.sh/chart: {{ include "kub2.chart" . }}
{{ include "kub2.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "kub2.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "kub2.fullname" .) .Values.serviceAccount.name }}
{{- else }}
